...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Program"] = $PS["Program"] || {};
  var exports = $PS["Program"];
  var Data_Either = $PS["Data.Either"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Identity = $PS["Data.Identity"];
  ...
  var Stationary = (function () {
      ...
      Stationary.value = new Stationary();
      return Stationary;
  })();
  var Fast = (function () {
      function Fast() {
  ...
  var program = Text_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)([ Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reserved("stationary"))(Stationary.value), Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reserved("fast"))(Fast.value), Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(reserved("slow"))(Slow.value) ]);
  var parseProgram = function (x) {
      ...
      throw new Error("Failed pattern match at Program (line 28, column 18 - line 30, column 27): " + [ v.constructor.name ]);
  };                        
  var defaultProgram = Stationary.value;
...
(function($PS) {
  ...
  var runProgram = function (re) {
      return function __do() {
          var program = Effect_Ref.read(re.programRef)();
          if (program instanceof Program.Stationary) {
              return Data_Unit.unit;
          };
          if (program instanceof Program.Fast) {
              return Graphics_Three_Object3D.rotateIncrement()(re.mesh)(0.1)(0.1)(0.0)();
          };
          if (program instanceof Program.Slow) {
              return Graphics_Three_Object3D.rotateIncrement()(re.mesh)(3.0e-3)(3.0e-3)(0.0)();
          };
          throw new Error("Failed pattern match at RenderEngine (line 53, column 3 - line 56, column 61): " + [ program.constructor.name ]);
      };
  };
  ...
  var launchRenderEngine = function __do() {
      ...
      var programRef = Effect_Ref["new"](Program.defaultProgram)();
      var re = {
          scene: scene,
          camera: camera,
          renderer: renderer,
          ...
          return function (ea) {
              ...
              if (ea instanceof Evaluate) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      var v = Program.parseProgram(st.text);
                      if (v instanceof Data_Either.Right) {
