...
(function($PS) {
  ...
  var setPosZ = function (n) {
      return function (r) {
          ...
          $15.pos = (function () {
              var $12 = {};
              for (var $13 in r.pos) {
                  if ({}.hasOwnProperty.call(r.pos, $13)) {
                      $12[$13] = r["pos"][$13];
                  };
              };
              $12.z = n;
  ...
  var setPosY = function (n) {
      return function (r) {
          ...
          $21.pos = (function () {
              var $18 = {};
              for (var $19 in r.pos) {
                  if ({}.hasOwnProperty.call(r.pos, $19)) {
                      $18[$19] = r["pos"][$19];
                  };
              };
              $18.y = n;
  ...
  var setPosX = function (n) {
      return function (r) {
          ...
          $27.pos = (function () {
              var $24 = {};
              for (var $25 in r.pos) {
                  if ({}.hasOwnProperty.call(r.pos, $25)) {
                      $24[$25] = r["pos"][$25];
                  };
              };
              $24.x = n;
  ...
  var dancerPropertyParser = posPropertyParser;
...
(function($PS) {
  ...
  var Data_Foreign_EasyFFI = $PS["Data.Foreign.EasyFFI"];                
  var newGLTFLoader = Data_Foreign_EasyFFI.unsafeForeignFunction([ "" ])("new THREE.GLTFLoader");
  exports["newGLTFLoader"] = newGLTFLoader;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  ...
  var runDancer = function (v) {
      return function (d) {
          return function (dState) {
              return function __do() {
                  Graphics_Three_Object3D.setPosition()(dState.mesh)(d.pos.x)(d.pos.y)(d.pos.z)();
                  return dState;
              };
          };
      };
                  ...
                  if (v2 instanceof AST.Element && v2.value0 instanceof AST.Dancer) {
                      return function __do() {
                          var x = (function () {
                              ...
                              throw new Error("Failed pattern match at RenderEngine (line 101, column 8 - line 103, column 30): " + [ v3.constructor.name ]);
                          })();
  ...
  var launchRenderEngine = function __do() {
      ...
      var gltfLoader = ThreeJS.newGLTFLoader();
      var re = {
