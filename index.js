          ...
          return function (ea) {
              ...
              if (ea instanceof Evaluate) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      ...
                      throw new Error("Failed pattern match at Main (line 63, column 5 - line 67, column 61): " + [ v.constructor.name ]);
                  });
              };
              throw new Error("Failed pattern match at Main (line 59, column 22 - line 67, column 61): " + [ ea.constructor.name ]);
          };
      };
  };
