          ...
          return function __do() {
              ...
              (function () {
                  if (ms instanceof Data_Maybe.Just) {
                      return ThreeJS.setPositionOfAnything(ms.value0)(d.pos.x)(d.pos.y)(d.pos.z)();
                  };
                  if (ms instanceof Data_Maybe.Nothing) {
                      return Data_Unit.unit;
                  };
                  throw new Error("Failed pattern match at DancerState (line 30, column 3 - line 33, column 25): " + [ ms.constructor.name ]);
              })();
              return dState;
          };
      };
      ...
      return function (d) {
          return function __do() {
              ...
              ThreeJS.loadGLTF(d.url)(function (gltf) {
                  return function __do() {
                      Effect_Console.log("model loaded!")();
                      ThreeJS.addAnythingToScene(theScene)(gltf.scene)();
                      return Effect_Ref.write(new Data_Maybe.Just(gltf.scene))(gltfScene)();
                  };
              })();
              return {
                  gltfScene: gltfScene
