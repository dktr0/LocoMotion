          ...
          return function __do() {
              ...
              (function () {
                  if (ms instanceof Data_Maybe.Just) {
                      ...
                      ThreeJS.setRotationOfAnything(ms.value0)(d.rot.x)(d.rot.y)(d.rot.z)();
                      ThreeJS.setScaleOfAnything(ms.value0)(d.scale.x)(d.scale.y)(d.scale.z)();
                      ...
                      throw new Error("Failed pattern match at DancerState (line 52, column 7 - line 54, column 29): " + [ am0.constructor.name ]);
                  };
                  if (ms instanceof Data_Maybe.Nothing) {
                      return Data_Unit.unit;
                  };
                  throw new Error("Failed pattern match at DancerState (line 46, column 3 - line 55, column 25): " + [ ms.constructor.name ]);
              })();
              return dState;
          };
      };
          ...
          return function __do() {
              ...
              ThreeJS.loadGLTF(d.url)(function (gltf) {
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at DancerState (line 34, column 5 - line 40, column 27): " + [ v.constructor.name ]);
                  };
              })();
              return {
                  gltfScene: gltfScene,
...
(function($PS) {
  ...
  var setSize = function (dictSemiring) {
      return function (n) {
          return function (r) {
              var $27 = {};
              for (var $28 in r) {
                  if ({}.hasOwnProperty.call(r, $28)) {
                      $27[$28] = r[$28];
                  };
              };
              $27.scale = {
                  x: Data_Semiring.mul(dictSemiring)(r.scale.x)(n),
                  y: Data_Semiring.mul(dictSemiring)(r.scale.y)(n),
                  z: Data_Semiring.mul(dictSemiring)(r.scale.z)(n)
              };
              return $27;
          };
      };
  ...
  var setScaleZ = function (n) {
      return function (r) {
          var $33 = {};
          for (var $34 in r) {
              if ({}.hasOwnProperty.call(r, $34)) {
                  $33[$34] = r[$34];
              };
          };
          $33.scale = (function () {
              var $30 = {};
              for (var $31 in r.scale) {
                  if ({}.hasOwnProperty.call(r.scale, $31)) {
                      $30[$31] = r["scale"][$31];
                  };
              };
              $30.z = n;
  ...
  var setScaleY = function (n) {
      return function (r) {
          var $39 = {};
          for (var $40 in r) {
              if ({}.hasOwnProperty.call(r, $40)) {
                  $39[$40] = r[$40];
              };
          };
          $39.scale = (function () {
              var $36 = {};
              for (var $37 in r.scale) {
                  if ({}.hasOwnProperty.call(r.scale, $37)) {
                      $36[$37] = r["scale"][$37];
                  };
              };
              $36.y = n;
  ...
  var setScaleX = function (n) {
      return function (r) {
          ...
          $45.scale = (function () {
              var $42 = {};
              for (var $43 in r.scale) {
                  if ({}.hasOwnProperty.call(r.scale, $43)) {
                      $42[$43] = r["scale"][$43];
                  };
              };
              $42.x = n;
  ...
  var setRotZ = function (n) {
      return function (r) {
          ...
          $51.rot = (function () {
              var $48 = {};
              for (var $49 in r.rot) {
                  if ({}.hasOwnProperty.call(r.rot, $49)) {
                      $48[$49] = r["rot"][$49];
                  };
              };
              $48.z = n;
  ...
  var setRotY = function (n) {
      return function (r) {
          ...
          $57.rot = (function () {
              var $54 = {};
              for (var $55 in r.rot) {
                  if ({}.hasOwnProperty.call(r.rot, $55)) {
                      $54[$55] = r["rot"][$55];
                  };
              };
              $54.y = n;
  ...
  var setRotX = function (n) {
      return function (r) {
          ...
          $63.rot = (function () {
              var $60 = {};
              for (var $61 in r.rot) {
                  if ({}.hasOwnProperty.call(r.rot, $61)) {
                      $60[$61] = r["rot"][$61];
                  };
              };
              $60.x = n;
  ...
  var setPosZ = function (n) {
      return function (r) {
          ...
          $69.pos = (function () {
              var $66 = {};
              for (var $67 in r.pos) {
                  if ({}.hasOwnProperty.call(r.pos, $67)) {
                      $66[$67] = r["pos"][$67];
                  };
              };
              $66.z = n;
  ...
  var setPosY = function (n) {
      return function (r) {
          ...
          $75.pos = (function () {
              var $72 = {};
              for (var $73 in r.pos) {
                  if ({}.hasOwnProperty.call(r.pos, $73)) {
                      $72[$73] = r["pos"][$73];
                  };
              };
              $72.y = n;
  ...
  var setPosX = function (n) {
      return function (r) {
          ...
          $81.pos = (function () {
              var $78 = {};
              for (var $79 in r.pos) {
                  if ({}.hasOwnProperty.call(r.pos, $79)) {
                      $78[$79] = r["pos"][$79];
                  };
              };
              $78.x = n;
