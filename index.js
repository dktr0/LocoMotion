...
(function($PS) {
                  ...
                  if (v2 instanceof AST.Element && v2.value0 instanceof AST.Dancer) {
                      return function __do() {
                          var x = (function () {
                              ...
                              throw new Error("Failed pattern match at RenderEngine (line 90, column 8 - line 92, column 36): " + [ v3.constructor.name ]);
                          })();
  ...
  var launchRenderEngine = function __do() {
      ...
      var hemiLight = ThreeJS.newHemisphereLight(16777215)(4473924)(1.0)();
