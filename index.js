...
(function($PS) {
                      ...
                      if (v3 instanceof AST.Element && v3.value0 instanceof AST.Dancer) {
                          return function __do() {
                              var x = (function () {
                                  ...
                                  throw new Error("Failed pattern match at RenderEngine (line 134, column 8 - line 136, column 36): " + [ v4.constructor.name ]);
                              })();
  ...
  var requestAnimationFrame$prime = function (x) {
      return function __do() {
          var w = Web_HTML.window();
          Web_HTML_Window.requestAnimationFrame(x)(w)();
          return Data_Unit.unit;
      };
  };
  ...
  var animate = function (re) {
      return function __do() {
          ...
          return requestAnimationFrame$prime(animate(re))();
      };
  };
  var launchRenderEngine = function (cvs) {
      return function __do() {
          ...
          requestAnimationFrame$prime(animate(re))();
          return re;
      };
  };
